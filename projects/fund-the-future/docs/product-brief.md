...
**Climate is being experienced rather than forecast, and that changes who is available to ask.** Across 142 countries and more than 128,000 people, those who have lived through floods or heatwaves are significantly more likely to rate climate change a very serious threat, and across 77 countries 43% thought extreme weather was worse than the year before.[^16] Among 16 to 25 year olds in ten countries, 59% are very or extremely worried and 75% say the future is frightening.[^16]
...
**Two findings point the other way and are recorded here rather than in a footnote.** About 80% of disaster-related giving happens in the first 72 hours, and in one year studied only 2% of donors gave to recovery from disasters in earlier years.[^16] Adaptation has no 72-hour window, so the reflex that moves climate money fastest is the one this product cannot use. More directly, a study of 1.23 million IRS Form 990 filings from 2010 to 2021 found donations rising with climate risk for hospitals and human-service organisations while **internationally-focused nonprofits saw declines**.[^16] Read plainly, US donors give closer to home as climate risk rises, which is the behaviour this product depends on moving the wrong way. It measures US-registered international nonprofits rather than direct cross-border gifts, and its window closes before the adaptation-philanthropy growth above, but it is the strongest counter-evidence in the project.
...
**Whether donors give closer to home as climate risk rises.** The IRS-filing study is the strongest counter-evidence in the project and it is unresolved in two ways: whether it describes donor preference moving homeward or the reporting behaviour of US-registered international nonprofits, and whether it still holds after 2021, since its window closes before the adaptation-philanthropy growth above.[^16]
