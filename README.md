...
- `build_docs.py` - script that renders the markdown docs into styled HTML pages

Each additional case study (Groundtruth, and future ones) lives in its own dedicated repo, linked from the portfolio hub, rather than being duplicated here.
